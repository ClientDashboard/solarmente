...
export default function ProposalForm() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-6 bg-black relative overflow-hidden">
      ...
      <div className={`relative z-10 w-full max-w-xl mx-auto px-4 transition-all duration-1000 ${animationComplete ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl text-white font-light mt-2 mb-3 tracking-wide">
        ...
        {/* Form Container */}
        <div className="bg-black border border-[#FF671F]/30 rounded-2xl shadow-2xl shadow-[#FF671F]/10 overflow-hidden">
          {/* Progress Bar */}
