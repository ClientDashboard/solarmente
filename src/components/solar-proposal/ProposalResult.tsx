    ...
    <main className={`min-h-screen ${bgMain} transition-colors duration-300`}>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className={`text-center ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} text-sm`}>
          <p>© {new Date().getFullYear()} SolarMente | Esta propuesta es válida por 15 días</p> Los calculos son basados en su consumo registrado en el formulario. De interesarle la propuesta se hace una visita antes.
